namespace AutopilotMonitor.Shared
{
    ...
    public static class Constants
    {
        ...
        public static class EventTypes
        {
            ...
            public const string ImePatternHits            = "ime_pattern_hits";          // Info, once per session at termination: per-pattern match counts for every enabled IME log pattern (zeros included) + tracker health counters. Backend aggregates per IME version (ImePatternStats) — the pattern-drift signal.
