...
namespace AutopilotMonitor.Shared.Models
{
    ...
    /// </summary>
    public class SubmitSessionReportRequest : IApiRequest
    {
    ...
    /// </summary>
    public class SubmitDiagFilesReportRequest : IApiRequest
    {
        public string TenantId { get; set; } = default!;
        public string? Comment { get; set; }
        public string? Email { get; set; }
    ...
    /// <summary>Body of PATCH global/session-reports/{reportId}/note; empty clears the note.</summary>
    public class UpdateSessionReportNoteRequest : IApiRequest
    {
