...
public class CriticalTableBackupServiceTests
{
    ...
    public async Task Happy_AllTables_OutcomeSuccess_ManifestWritten()
    {
        ...
        Assert.Equal(19, result.Manifest.Tables.Count);   // critical-tables catalog count (incl. DelegatedAdmins + ConfigurationBackups + SessionAnnotations + AdminIdentityBindings)
