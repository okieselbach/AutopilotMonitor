    ...
    public class GetTenantConfigurationFunction
    {
            ...
            string tenantId)
        {
            try
            {
                ...
                // Operators/Viewers are admitted for a READ-ONLY view (secrets redacted below).
                ...
                // UI). Everyone else admitted to this read tier — an own-tenant Operator/Viewer, a
                // cross-tenant Global Reader, or a delegated reader viewing one of their managed
                // tenants — gets the secrets redacted (returns
            ...
            {
                return await req.InternalServerErrorAsync(_logger, ex, "GetTenantConfiguration");
            }
        }
        ...
        /// Admin (any tenant), or the tenant's OWN admin. Everyone else admitted to this read tier — an
        /// own-tenant Operator/Viewer (read-only Settings view), a cross-tenant Global Reader, or a
        /// delegated reader viewing one of their managed tenants — is
