    ...
    public class GetGlobalGeographicMetricsFunction
    {
            ...
            CancellationToken cancellationToken)
        {
            try
            {
                ...
                var sessionsTask = _maintenanceRepo.GetGeoWindowSessionsAsync(cutoff, now.AddDays(1), tenantFilter, cancellationToken);
            ...
            {
                return await req.InternalServerErrorAsync(_logger, ex, "GetGlobalGeographicMetrics");
            }
        }
    }
}
