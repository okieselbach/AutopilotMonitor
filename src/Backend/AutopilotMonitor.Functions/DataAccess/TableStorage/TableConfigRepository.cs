    ...
    public class TableConfigRepository : IConfigRepository
    {
        ...
        internal static TableEntity ConvertToTenantTableEntity(TenantConfiguration config)
        {
            var entity = new TableEntity(config.TenantId, "config")
            {
                ...
                { "DpaVersion", config.DpaVersion },
                { "ContactEmail", config.ContactEmail },
                { "CompanyName", config.CompanyName },
                { "Disabled", config.Disabled },
                { "DisabledReason", config.DisabledReason },
                { "DisabledUntil", config.DisabledUntil },
                { "McpDisabled", config.McpDisabled },
                { "McpDisabledReason", config.McpDisabledReason },
                { "McpClientRegistrationLimit", config.McpClientRegistrationLimit },
                ...
                { "EnableDoGroupIdAutoSet", config.EnableDoGroupIdAutoSet },
        ...
        internal static TenantConfiguration ConvertFromTenantTableEntity(TableEntity entity)
        {
            return new TenantConfiguration
            {
                ...
                DpaVersion = entity.GetString("DpaVersion"),
                ...
                McpDisabled = entity.GetBoolean("McpDisabled") ?? false,
                McpDisabledReason = entity.GetString("McpDisabledReason"),
                McpClientRegistrationLimit = entity.GetInt32("McpClientRegistrationLimit"),
                ...
                EnableDoGroupIdAutoSet = entity.GetBoolean("EnableDoGroupIdAutoSet"),
        ...
        internal static TableEntity ConvertToAdminTableEntity(AdminConfiguration config)
        {
            var entity = new TableEntity("GlobalConfig", "config")
            {
                ...
                { "ImeMsiArchivingEnabled", config.ImeMsiArchivingEnabled },
                { "MaxImeMsiDownloadSizeMB", config.MaxImeMsiDownloadSizeMB },
                ...
                { "NvdCacheLastRefreshUtc", config.NvdCacheLastRefreshUtc },
                { "EpssLastSyncUtc", config.EpssLastSyncUtc },
        ...
        internal static AdminConfiguration ConvertFromAdminTableEntity(TableEntity entity)
        {
            return new AdminConfiguration
            {
                ...
                ImeMsiArchivingEnabled = entity.GetBoolean("ImeMsiArchivingEnabled") ?? true,
                MaxImeMsiDownloadSizeMB = entity.GetInt32("MaxImeMsiDownloadSizeMB") ?? 250,
                ...
                NvdCacheLastRefreshUtc = entity.GetString("NvdCacheLastRefreshUtc"),
                EpssLastSyncUtc = entity.GetString("EpssLastSyncUtc"),
