          ...
          <label className="block">
            ...
            {isRetentionDisabled ? (
              <div className="mt-2 flex items-start space-x-2 bg-amber-50 border border-amber-200 rounded-md px-3 py-2">
                {/* w-4/h-4 matches the text-xs line box exactly, so items-start aligns the icon
                    with the first line without a hand-tuned margin (the bare glyph inherited the
                    base 16px size against 12px text and sat too low). */}
                <svg
