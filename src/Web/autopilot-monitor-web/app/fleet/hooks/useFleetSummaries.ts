 ...
 *
 * @param tenantIds the managed tenant IDs to summarize.
 * @param days      lookback window passed to each per-tenant stats call.
 */
export function useFleetSummaries(tenantIds: string[], days: number): FleetSummariesState {
