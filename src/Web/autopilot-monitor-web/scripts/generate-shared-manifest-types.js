...
const MCP_VOCABULARIES = [
  ...
  { section: "ruleSubmissionKinds", constName: "RULE_SUBMISSION_KINDS", typeName: "RuleSubmissionKind",
    doc: "Community rule submission kinds (C# RuleSubmissionKinds)." },
  { section: "ruleSubmissionStatuses", constName: "RULE_SUBMISSION_STATUSES", typeName: "RuleSubmissionStatus",
    doc: "Effective rule submission statuses incl. the derived published (C# RuleSubmissionStatuses)." },
  { section: "ruleAttributionModes", constName: "RULE_ATTRIBUTION_MODES", typeName: "RuleAttributionMode",
    doc: "How a contributed rule credits its author (C# RuleAttributionModes)." },
  { section: "ruleSubmissionDecisions", constName: "RULE_SUBMISSION_DECISIONS", typeName: "RuleSubmissionDecision",
    doc: "Reviewer decisions on a rule submission (C# RuleSubmissionDecisions)." },
