        ...
        <div className="px-3">
          <div className="flex justify-between h-14">
            <div className="flex items-center">
              <NavLink href="/progress" className="flex items-center space-x-2.5">
    ...
    <nav className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-30">
      <div className="px-3">
        <div className="flex justify-between h-14">
          {/* Logo and Title */}
          <div className="flex items-center">
            <NavLink href="/" className="flex items-center space-x-2.5">
              <BrandMark className="w-6 h-6" />
                ...
                <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-50 py-1">
                  ...
                  {overflowSubmenu === 'help' && (
                    <>
                      ...
                      <NavLink href="/terms" className="w-full flex items-center gap-2.5 px-3 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors" onClick={() => { setShowOverflow(false); setOverflowSubmenu(null); }}>
