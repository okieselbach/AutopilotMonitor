 ...
 *
 *   node tools/error-codes/generate.mjs [--cache-dir DIR] [--check]
 *
...
async function main() {
  ...
  const header = {
    schemaVersion: 2,
    description:
      "Single-source catalog of Windows / MSI / Intune error codes, generated by tools/error-codes/generate.mjs from primary sources — " +
